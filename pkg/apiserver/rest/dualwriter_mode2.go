...
func newDualWriterMode2(legacy LegacyStorage, storage Storage, dwm *dualWriterMetrics, kind string, group string, resource string, namespacer grafanarequest.NamespaceMapper) *DualWriterMode2 {
