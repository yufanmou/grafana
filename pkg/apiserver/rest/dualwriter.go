...
func NewDualWriter(mode DualWriterMode, legacy LegacyStorage, storage Storage, reg prometheus.Registerer, kind string, requestInfo *request.RequestInfo, serverLockService *serverlocksvc.ServerLockService) DualWriter {
